...
function than the 1-location optimum plus two other locations! 
...
Try that random restart with a gradient-based optimizer again. 
Use "L-BFGS-B" to support bounds. Plot triangles found in 
...
nruns=4
# this takes 5-10 minutes for 20 runs..
...
three_loc_de <- DEoptim(cmpfun(p2lsN_cost_opt), lower=lower_box, upper=upper_box,
                     control=list(NP=80, itermax=200, trace=TRUE, 
...
* Profile this R code, find out why it's slow, and fix it.
